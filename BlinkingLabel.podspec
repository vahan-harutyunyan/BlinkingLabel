...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/vahan-harutyunyan/BlinkingLabel"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Vahan Harutyunyan" => "vahan@twotalltotems.com" }
  s.source           = { :git => "https://github.com/vahan-harutyunyan/BlinkingLabel.git", :tag => s.version.to_s }
